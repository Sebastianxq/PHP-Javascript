											...
											<table cellpadding="0" cellspacing="0" border="0">
												...
												<tbody class="color-a">
													<tr>
														<td></td>
														<td class="right">
															<!--BOTTOM LINES UP UNTIL SCRIPT MODIFIED-->
															<input type="hidden" name="sessionId" id="sessionId" value=""/>
															
															<button onclick="assignSessionID()" type="submit" onfocus="this.blur()">{#send#}</button>
															<script>
															function assignSessionID(){
																//using document.cookie gets sessid but other noise as well
																var sId = document.cookie.split(';')
